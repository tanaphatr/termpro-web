        ...
        <Fragment>
            <Card sx={{ padding: 2 }}>
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <Typography variant="h6" sx={{ marginTop: 2 }}>ยอดรวมทั้งหมด: {watch("total")}</Typography>
                    </Grid>
                    <Grid item xs={12}>
                        <Typography variant="h6" sx={{ marginTop: 2 }}>สรุปยอดขายสินค้า | จำนวน: {products.length}</Typography>
                    </Grid>
